...
product_list =["Hedgeye Investor", "Hedgeye Risk Manager", "HI2" , "Macro (22)" , "Macro (40)", "morning_newsletter_1", "morning_stock_alerts_weekly_ideas_1", "Real-Time Alerts","Retail PRO", "weekly_ideas_1", "investing_ideas_1",  "internal", "Daily Trading Ranges"]
...
emailbadtext = ["hedgeye.com", "example.com", "scottnelson", "mrjames", "spamcatch", "fred-strammer@comcast.net","example2.com","tvannoy", "e-xample.com"]
...
##############################################################################################################
# Output to a csv
	totalprods = hi_count+hrm_count+hi2_count+macro22_count+macro40_count+mnl_count+combo3_count+rta_count+retailpro_count+whi_count+invideas_count+dtr_count
